...
public class CatalogueTestWhereisGenerated {
	...
	public static void main(final String[] args) throws IOException {
		...
		if (nargs < 1) {
			System.err.println("Usage: ./run.sh alien/src/test/CatalogueTestWhereisGenerated <alien_path> [<pool_size>] [<logs_suffix>]");
		...
		int cl = Integer.parseInt(args[7]);
		if (cl == 1)
		...
		System.out.println("Going to whereis autogenerated consistency: " + clevel.toString() + " type: " + type + " limit_count: " + limit_count + " limit: " + limit + "*10 in " + args[4]
		...
		public void run() {
			...
			for (int i = 1; i <= 10; i++) {
				...
				case 0: // LFN
					...
					break;
				case 1: // LFN_CSD
					LFN_CSD lfnc = new LFN_CSD(lfn, true);					
					HashMap<Integer, String> pfnsc = lfnc.whereis("catalogue.lfns", clevel);
