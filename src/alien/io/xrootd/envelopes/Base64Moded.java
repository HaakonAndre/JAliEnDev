...
public class Base64Moded
{
        ...
        if( gzip == GZIP )
            {
                java.io.ByteArrayOutputStream  baos  = null;
                java.util.zip.GZIPOutputStream gzos  = null;
                Base64Moded.OutputStream            b64os = null;
    ...
    public static boolean encodeToFile( byte[] dataToEncode, String filename )
    {
        ...
        Base64Moded.OutputStream bos = null;
        try
            {
                bos = new Base64Moded.OutputStream(
                                              new java.io.FileOutputStream( filename ), Base64Moded.ENCODE );
    ...
    public static boolean decodeToFile( String dataToDecode, String filename )
    {
        ...
        try
            {
                bos = new Base64Moded.OutputStream(
                                              new java.io.FileOutputStream( filename ), Base64Moded.DECODE );
    ...
    public static byte[] decodeFromFile( String filename )
    {
        ...
        Base64Moded.InputStream bis = null;
        try
            {
                ...
                // Open a stream
                bis = new Base64Moded.InputStream(
                                             new java.io.BufferedInputStream(
                                                                             new java.io.FileInputStream( file ) ), Base64Moded.DECODE );
        ...
        try
            {
                ...
                bis = new Base64Moded.InputStream(
                                             new java.io.BufferedInputStream(
                                                                             new java.io.FileInputStream( file ) ), Base64Moded.ENCODE );
    ...
    /**
     * A {@link Base64Moded.InputStream} will read data from another
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
        ...
        /**
         * Constructs a {@link Base64Moded.InputStream} in
    ...
    /**
     * A {@link Base64Moded.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        /**
         * Constructs a {@link Base64Moded.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
                    ...
                    if( DECODABET[ theByte & 0x7f ] > WHITE_SPACE_ENC )
                        {
                            ...
                            if( position >= bufferLength )  // Enough to output.
                                {
                                    int len = Base64Moded.decode4to3( buffer, 0, b4, 0 );
                                    out.write( b4, 0, len );
